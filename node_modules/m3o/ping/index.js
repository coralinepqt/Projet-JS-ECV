...
var PingService = /** @class */ (function () {
    function PingService(token) {
        this.client = new m3o.Client({ token: token });
    }
    // Ping an IP address
    PingService.prototype.ip = function (request) {
        return this.client.call("ping", "Ip", request);
    };
    // Ping a TCP port is open
    PingService.prototype.tcp = function (request) {
        return this.client.call("ping", "Tcp", request);
    };
    // Ping a HTTP URL
    PingService.prototype.url = function (request) {
